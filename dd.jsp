...
<td  width="1200" align="center" bgcolor="#FFBBDD">
...
//创建执行语句
String sql="select * from bar.goods";
...
<tr>
    ...
    <td><%=rs.getString("buynumber")%></td>
    <td><%=rs.getString("userid")%></td>
    <td><%=rs.getString("price")%></td>
    <td><%=rs.getString("goodinfoid")%></td>
...
out.print("&nbsp;&nbsp;<a href='dd.jsp?page="+(intPage-1)+"'>"+"["+"前一页"+"]"+"</a>"+"&nbsp;&nbsp;");
for(int j=1;j<=intPageCount;j++)
{

out.print("&nbsp;&nbsp;<a href='dd.jsp?page="+j+"'>"+"["+j+"]"+"</a>");
}
out.print("&nbsp;&nbsp;<a href='dd.jsp?page="+(intPage+1)+"'>"+"["+"后一页"+"]"+"</a>"+"&nbsp;&nbsp;");
%>
