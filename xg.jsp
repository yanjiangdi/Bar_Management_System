...
<form action="xg.jsp">
	...
	<p align="center">
    	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size="-1">账户余额：</font><input type="text" width="200" value=<%=s1 %>>
    </p>
    <p align="center">
   	 &nbsp;性别：<font color="#09F1D1">男</font><input type="radio" name="性别" width="20">---<font color="#0C03E3">女</font><input type="radio" name="性别">
    </p>
    <p align="center"> 
    	&nbsp;&nbsp;&nbsp;&nbsp;生日：<input type="date"  height="30" width="200" value=<%=s2 %>>
    </p>
    <p align="center">
    	<font><font >&nbsp;&nbsp;&nbsp;&nbsp; Email：</font></font><input type="text" height="30" width="200" value=<%=s3 %>>
    </p>
    <p align="center">
    	<font><font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;安全问题：</font></font><input type="text" width="200" height="30" value=<%=s4 %>>
    </p>
	    <p align="center">
    	<font><font>&nbsp;&nbsp;&nbsp;&nbsp;姓名：</font></font><input type="text" width="200" height="30" value=<%=s5 %>>
    </p>
	    <p align="center">
    	<font><font>&nbsp;&nbsp;&nbsp;&nbsp;电话：</font></font><input type="text" width="200" height="30" value=<%=s6 %>>
    </p>
	    <p align="center">
    	<font><font>&nbsp;&nbsp;&nbsp;&nbsp;答案：</font></font><input type="text" width="200" height="30" value=<%=s7 %>>
    </p>
    <p align="center">
