...
<div align="center"><strong>酒吧新闻</strong></div>
<br><hr>
...
//创建执行语句
String sql="select * from bar.articles";
...
out.print("&nbsp;&nbsp;<a href='jbxw.jsp?page="+(intPage-1)+"'>"+"["+"前一页"+"]"+"</a>"+"&nbsp;&nbsp;");
for(int j=1;j<=intPageCount;j++)
{

out.print("&nbsp;&nbsp;<a href='jbxw.jsp?page="+j+"'>"+"["+j+"]"+"</a>");
}
out.print("&nbsp;&nbsp;<a href='jbxw.jsp?page="+(intPage+1)+"'>"+"["+"后一页"+"]"+"</a>"+"&nbsp;&nbsp;");
%>
