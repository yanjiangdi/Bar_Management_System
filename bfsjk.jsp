...
<tr height="30">
<td  width="300"></td>
<td width="100" bgcolor="#3333FF" ><a   style="text-decoration:none" href="bfsjk1.jsp"><font color="#FFFFFF">备份数据库</font></a></td>
<td width="300"></td>
<td width="100" bgcolor="#3333FF" ><a  style="text-decoration:none" href="hfsjk2.jsp"><font color="#CCCCCC">恢复数据库</font></a></td>
