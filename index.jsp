...
<td width="10"></td>
<td width="47"><a href="index.jsp"><font color="#FFFFFF">首页</font></a></td>
...
<td width="150" align="center"><font color="#FFFFFF">用户名：<input type="text" name="uname"/> </font></td>
<td width="150" align="right"><font color="#FFFFFF">密码：<input type="password" name="pwd"/> </font></td>
<td width="50" align="right"><input type="submit" value="登陆"></td>
</form>
<td width="50" align="right"><a href="zc.jsp"><input type="submit" value="注册"></a></td>
