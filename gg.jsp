...
<div align="center"><strong>酒吧公告！</strong></div>
<br><hr>
...
out.print("&nbsp;&nbsp;<a href='gg.jsp?page="+(intPage-1)+"'>"+"["+"前一页"+"]"+"</a>"+"&nbsp;&nbsp;");
for(int j=1;j<=intPageCount;j++)
{

out.print("&nbsp;&nbsp;<a href='gg.jsp?page="+j+"'>"+"["+j+"]"+"</a>");
}
out.print("&nbsp;&nbsp;<a href='gg.jsp?page="+(intPage+1)+"'>"+"["+"后一页"+"]"+"</a>"+"&nbsp;&nbsp;");
%>
