...
<%
	...
	String s1=request.getParameter("sitename");
	String s2=request.getParameter("keywords");
...
<table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="446">&nbsp;
      <input name="sitename" type="text" value=<%=s1%> /></td>
  </tr>
  <tr>
    <td height="34" align="right">关键字设置：</td>
    <td width="446">&nbsp;
      <input name="keywords" type="text" value=<%=s2 %> /></td>
  </tr>
  <tr>
    <td height="24" align="right">网&nbsp;站&nbsp;描&nbsp;述&nbsp;：</td>
    <td width="446">&nbsp;
      <input name="description" type="text" value=<%=s3 %> /></td>
  </tr>
  <tr>
    <td height="25" align="right">网站负债人：</td>
    <td width="446">&nbsp;
      <input name="author" type="text" value=<%=s4 %> /></td>
  </tr>
  <tr>
    <td height="26" align="right">网站E-mail：&nbsp;</td>
    <td> &nbsp;
      <input name="email" type="text" value=<%=s5 %> /></td>
  </tr>
  <tr>
    <td height="38" align="right">联&nbsp;系&nbsp;电&nbsp;话：&nbsp;</td>
    <td>&nbsp; <input name="tel" type="text" class="input2" value=<%=s6 %> /></td>
  </tr>
  <tr>
